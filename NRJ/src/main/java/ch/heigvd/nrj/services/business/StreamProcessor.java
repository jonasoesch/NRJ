...
/**
 * The Stream Processor processes the incoming info from the Plugs. The method
 * onConsumption is called each time a new ConsumptionObs is send to our
 * WebService
 *
 * @author jonas
 */
...
public class StreamProcessor implements StreamProcessorLocal {
    ...
    /**
     * Creates or updates consumptionFacts for a Plug, a Room and the Apartment
     * with the given Consumption Observation
     *
     * @param o, the ConsumptionObservation
     */
    @Override
